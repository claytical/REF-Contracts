pub contract RichEntitledFuck {
    ...
    pub resource NFTMinter {
        ...
        pub fun mint(): @NFT {
            ...
            RichEntitledFuck.ownerMap[self.idCount] = RichEntitledFuck.account.address
    ...
    init() {
        self.ownerMap = {}
        self.account.save(<-self.createEmptyCollection(), to: /storage/RichEntitledFuckCollection)
        self.account.link<&{NFTReceiver}>(/public/NFTReceiver, target: /storage/RichEntitledFuckCollection)
